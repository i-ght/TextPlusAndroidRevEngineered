...
{
    public class WpfTxtPlusCreatorDataGridItem : ViewModelBase
    {
        private string _id;
        private string _status;

        public WpfTxtPlusCreatorDataGridItem(DataGrid dataGrid)
        {
            _id = "";
            _status = "";
    ...
    public class WpfUIUpdater : UIUpdater, IDisposable
    {
        ...
        private readonly ObservableCollection<WpfTxtPlusCreatorDataGridItem> _items;
        private readonly WpfInt64Label _attemptsUiLbl;
        private readonly WpfInt64Label _createdUiLbl;
        ...
        private Unit UpdateStat(WpfUIUpdaterUpdateStatDirective d)
        {
            ...
            {
                StatLabel.Attempts => _attemptsUiLbl,
                StatLabel.Created => _createdUiLbl,
        ...
        public WpfUIUpdater(
            MainWindow mWindow,
            ObservableCollection<WpfTxtPlusCreatorDataGridItem> items,
            WpfInt64Label attemtptsUiLbl,
            WpfInt64Label createUiLbl)
        {
            _mWindow = mWindow;
            _attemptsUiLbl = attemtptsUiLbl;
            _createdUiLbl = createUiLbl;
            _items = items;
    ...
    public class WpfStatsUIUpdater : StatsUIUpdater
    {
        ...
        public WpfStatsUIUpdater(WpfUIUpdater uiUpdater)
        {
        ...
        {
            lock (_uiUpdater)
                _uiUpdater.UpdateStat(StatLabel.Attempts, 1);
        }

        public override void IncrementCreated()
        {
            lock (_uiUpdater)
                _uiUpdater.UpdateStat(StatLabel.Created, 1);
        }
    }
